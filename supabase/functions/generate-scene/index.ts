...
const PACK_WARDROBE: Record<string, string> = {
  "old-money":
    "PREFERRED for a man — FIT 1: a well-fitted linen or fine-cotton button-down (long- or short-sleeve) in white, cream, pale blue or navy with tailored linen or chino trousers and leather loafers or minimal sneakers, optionally a navy blazer over it; OR FIT 2: a tight, good-fitting plain tee or fine polo in white, navy or cream with sharp tailored trousers. For a woman: a tailored white shirt with cream wide-leg trousers, an elegant linen co-ord, or a refined summer dress with delicate gold jewelry — understated old-money elegance",
  "euro-summer":
...
const STYLE_PACKS: Record<string, string> = {
  ...
  "old-money":
    "STYLE — Old Money (Riviera / Monaco quiet wealth): the aesthetic of Monaco and the Côte d'Azur old-money elite. SETTINGS (pick what fits the request): a cobbled Monaco hillside street lined with cream Belle-Époque buildings, ornate wrought-iron balconies, palms and bougainvillea, descending to a harbor full of white yachts with a green headland behind; a classic car — a vintage Porsche 911 or a cream Rolls-Royce — parked on the cobbles or at a grand hotel forecourt; a Belle-Époque hotel sun-terrace or balcony overlooking Cap-Ferrat and a bay dotted with yachts; a marble café terrace under striped awnings; a stone villa loggia framed by an arch over the Riviera / Lake Como with cypress and lemon trees. LIGHT: bright hazy Mediterranean daylight, warm and slightly golden, soft haze on the distant headland (atmospheric perspective), long soft midday-to-afternoon shadows. COLOR: warm cream stone + terracotta + deep-green foliage + Mediterranean blue sea, muted and elegant — quiet wealth, never neon or candy-HDR. MOOD: effortless, moneyed, unhurried.",
  "euro-summer":
