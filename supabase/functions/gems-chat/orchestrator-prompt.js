...
CONTRACT (every field required; null when unused):
{
  ...
  "generate": { "kind": "scene" | "commitment", "stylePack": "euro-summer" | "dubai" | "old-money" | "luxury-cars" | "beach-club" | "boat" | "dark-luxe" | "after-dark" | null, "mode": "me" | "background", "prompt": string | null } | null
}
