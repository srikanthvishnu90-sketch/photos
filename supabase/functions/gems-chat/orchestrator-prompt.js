...
CONTRACT (every field required; null when unused):
{
  ...
  "generate": { "kind": "scene" | "commitment", "stylePack": "euro-summer" | "dubai" | "boat" | "dark-luxe" | "after-dark" | null, "mode": "me" | "background", "prompt": string | null } | null
}
